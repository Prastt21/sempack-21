                    ...
                    <div class="row">                       
                        <div class="col-xs-4">
                            <div class="input-group input-group-sm">
                                <form action="<?php echo base_url('data_peminjaman_aula/cari'); ?>" method="post" class="form-inline" role="form">
