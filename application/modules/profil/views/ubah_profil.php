<section class="content-header">
    <h1>
        Ubah Data
        <small>Ubah Data Profil <?php echo $result_profil['Nama_Pengguna']; ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-8">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('profil/proses_ubah_profil'); ?>" id="form-tambah-pengguna" method="post">
                        <input name="id_pengguna" type="hidden" value="<?php echo set_value('id_pengguna', $result_profil['Id_Pengguna']); ?>">                        
                        <div class="form-group">
                            <label for="nama-pengguna" class="col-lg-3 control-label">Nama Pengguna</label>
                            <div class="col-lg-5">
                                <input type="text" name="nama_pengguna" maxlength="100" class="form-control input-sm" placeholder="Nama Pengguna" value="<?php echo set_value('nama_pengguna', $result_profil['Nama_Pengguna']); ?>">
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            <label for="status-pengguna" class="col-lg-3 control-label">Status Pengguna</label>
                            <div class="col-lg-5">
                                <select name="status" class="form-control input-sm" style="width: 150px;">
                                    <option></option>
                                    <option value="MAHASISWA" <?php echo set_value('status', $result_profil['Status_Pengguna']) == 'MAHASISWA' ? 'selected="selected"' : ''; ?>>Mahasiswa</option>
                                    <option value="KARYAWAN" <?php echo set_value('status', $result_profil['Status_Pengguna']) == 'KARYAWAN' ? 'selected="selected"' : ''; ?>>Karyawan</option>                                    
                                </select>
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" name="username" maxlength="20" class="form-control input-sm" placeholder="Username" value="<?php echo set_value('username', $result_profil['NIK_NIM']); ?>">
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select name="jenis_kelamin" class="form-control input-sm" style="width: 150px;">
                                    <option></option>
                                    <option value="PRIA" <?php echo set_value('jenis_kelamin', $result_profil['Gender']) == 'PRIA' ? 'selected="selected"' : ''; ?>>Pria</option>
                                    <option value="WANITA" <?php echo set_value('jenis_kelamin', $result_profil['Gender']) == 'WANITA' ? 'selected="selected"' : ''; ?>>Wanita</option>                                    
                                </select>
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" name="telephone" maxlength="20" class="form-control input-sm" placeholder="Telephone" value="<?php echo set_value('telephone', $result_profil['No_Telp']); ?>">
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <textarea name="alamat" class="form-control" placeholder="Alamat Operator"><?php echo set_value('alamat', $result_profil['Alamat']); ?></textarea>
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" name="tempat_lahir" style="width: 150px;" maxlength="15" class="form-control input-sm" placeholder="Tempat Lahir" value="<?php echo set_value('tempat_lahir', $result_profil['Tempat_Lahir']); ?>">
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <div class="bfh-datepicker" data-name="tanggal" data-placeholder='tanggal' data-format="y-m-d" data-date="<?php echo set_value('tanggal', $result_profil['Tanggal_Lahir']); ?>"></div>
                            </div>
                            <div class="col-lg-3"><small><em>Harus diisi!</em></small></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" name="email" maxlength="100" class="form-control input-sm" placeholder="Email Operator" value="<?php echo set_value('email', $result_profil['Email']); ?>">
                            </div>
