                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <thead>
                            <tr>
                                ...
                                <td width="7%">Beasiswa</td>
                                <td width="10%">Pendaftar</td>
                                <td width="10%">Orang Tua</td>
                                <td width="11%">Jurusan</td>
                                <td width="3%">Semester</td>
                                <td width="3%">IPK</td>
                                <td width="8%">No Rekening</td>
                                <td width="5%">Tgl Daftar</td>
                            ...
                            if (isset($rs_beasiswa)) {
                                ...
                                foreach ($rs_beasiswa as $dt_beasiswa):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $dt_beasiswa['Nama_Ortu']; ?></td>
