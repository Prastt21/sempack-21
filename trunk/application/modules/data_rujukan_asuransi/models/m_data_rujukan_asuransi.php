...
class m_data_rujukan_asuransi extends CI_Model {

    public function __construct() {
        parent::__construct();
    }
    function ambil_data_rujukan_asuransi($parameter) {
    ...
    function get_data_rujukan_asuransi_by_id($parameter) {
    ...
    function ubah_data_rujukan_asuransi($parameter) {
        $sql = 'UPDATE asuransi SET Santunan=?, Status_Asuransi=? WHERE Id_Asuransi = ?';
        return $this->db->query($sql, $parameter);
    }

    function hapus_data_rujukan_asuransi($params) {
