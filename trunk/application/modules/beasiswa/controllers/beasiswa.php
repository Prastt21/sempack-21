...
class beasiswa extends operator_base {
    ...
    function tambah_beasiswa() {
        ...
        if ($this->input->post('simpan') != '') {
            ...
            $this->form_validation->set_rules('jenis_beasiswa', 'Jenis Asuransi', 'required|trim');
            $this->form_validation->set_rules('nama_pendaftar', 'Nama Perujuk', 'required|trim');
            $this->form_validation->set_rules('nama_ortu_pendaftar', 'Nama Rumah Sakit', 'required|trim');
